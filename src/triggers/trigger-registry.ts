import type { WorkflowTriggerBase } from "./base-trigger"
...
export class TriggerRegistry {
  private triggers: Map<string, new (properties: NodeProperties) => WorkflowTriggerBase> = new Map()
   ...
   */
  register(name: string, triggerClass: new (properties: NodeProperties) => WorkflowTriggerBase): void {
   ...
   */
  get(name: string): ((new (properties: NodeProperties) => WorkflowTriggerBase) | undefined) {
