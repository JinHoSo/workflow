...
**Package Organization**: The base Trigger class SHALL be provided by the `@workflow/core` package. Built-in trigger implementations SHALL be provided by the `@workflow/nodes` package, which depends on `@workflow/core`, `@workflow/interfaces`, and `@workflow/schemas`.
...
**Package Organization**: The ManualTriggerNode SHALL be provided by the `@workflow/nodes` package.
...
**Package Organization**: The ScheduledTrigger SHALL be provided by the `@workflow/nodes` package.
...
**Package Organization**: The WebhookTrigger SHALL be provided by the `@workflow/nodes` package.
...
**Package Organization**: The SocketTrigger SHALL be provided by the `@workflow/nodes` package.
...
**Package Organization**: The trigger registry and extensibility mechanisms SHALL be provided by the `@workflow/core` and `@workflow/plugins` packages.
